...
interface Reto { id: string; nombre: string; descripcion: string | null; activo: boolean; vence_en: string | null; beneficio_id?: string | null; tipo?: string; meta?: number }
...
export function RetosSection({ negocioId, inicial, beneficios }: { negocioId: string; inicial: Reto[]; beneficios: BeneficioOpcion[] }) {
  ...
  async function crear(e: React.FormEvent) {
    ...
    const { data } = await supabase
      ...
      .select('id, nombre, descripcion, activo, vence_en, beneficio_id, tipo, meta')
      .single();
